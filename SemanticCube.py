...
# semantic_cube[Type.INT][Type.INT][Operator.POS] = Type.INT
# semantic_cube[Type.INT][Type.INT][Operator.NEG] = Type.INT
...
# semantic_cube[Type.INT][Type.FLOAT][Operator.NOT] = Type.INT
...
# semantic_cube[Type.FLOAT][Type.INT][Operator.NOT] = Type.INT
...
# semantic_cube[Type.FLOAT][Type.FLOAT][Operator.NOT] = Type.INT
...
semantic_cube[Type.CHAR][Type.CHAR][Operator.OR] = Type.INT
semantic_cube[Type.CHAR][Type.CHAR][Operator.AND] = Type.INT
...
# semantic_cube[Type.CHAR][Type.CHAR][Operator.NOT] = Type.INT
