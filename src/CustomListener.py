...
class CustomListener(TeamPlusPlusListener):
    ...
    def push_quadruple(self, operator, left_operand, right_operand, result):
        ...
        # Attempts to recycle addresses used as operands
    ...
    def generate_quadruple(self, top_operator):
        ...
        # Creates a quadruple for the received operation and adds its resulting temporary variable to the operand stack
    ...
    # Generates GOTOF for conditional or looping statements
    ...
    # Generates GOTO quadruples for conditional statements with pending jumps
    ...
    # Generates GOTO quadruples for looping statements with pending jumps
    ...
    # Resolves all pending jumps generated by multi-conditional statements
    ...
    def enterVar(self, ctx):
        ...
        # Store current variable to caller_vars stack for later access
    ...
    def enterAttr(self, ctx):
        ...
        # If the variable calling an attribute has dimensions, verifies that it
        # was properly indexed and uses the corresponding pointer instead of the base address
        ...
        # Creates an 8-digit compound address for an instance's attribute
    ...
    def exitVal_var(self, ctx):
        ...
        # If the current variable has dimensions, verifies that it was properly indexed
        # and uses the corresponding pointer instead of the base address
        if var.dim_count > 0:
            if self.pointer_stack.empty():
                print("[Error] Cannot use array without indexing.")
                sys.exit()
    ...
    def exitVal_cte(self, ctx):
        # Obtains an address for the current constant value and creates an operand to add to the operand stack
    ...
    def enterFunc_name(self, ctx):
        ...
        # Verifies whether the called function is a method and searches for it in
        ...
        if self.is_method:
            ...
            # If the current variable has dimensions, verifies that it was properly
            # indexed and uses the corresponding pointer instead of the base address
            if var.dim_count > 0:
                if self.pointer_stack.empty():
                    print("[Error] Cannot use array without indexing.")
                    sys.exit()
            ...
            if self.dir_gen.in_class:
                # Functions cannot be declared before classes, so this function call
                # must be a method of the same class as the current context
    ...
    def exitVal_funcall(self, ctx):
        ...
        # Generates an assignment quadruple from the called function's return address
        # to a new temporal address and adds the temporal address to the operand stack
    ...
    def exitFactor_elem(self, ctx):
        ...
        if top_operator == Operator.POS or top_operator == Operator.NEG or top_operator == Operator.NOT:
            ...
            # Decides the type of the unary operation's result based on the involved operator and operand
    ...
    def exitFloop(self, ctx):
        ...
        # Generates quadruples to increase the value of the variable used in the from-to statement
    ...
    def exitSwitch_expr(self, ctx):
        ...
        # Adds the variable used for switch declaration to the recurrent variable stack
        # since we will create several quadruples using this variable without reading it again
    ...
    def exitFor_var(self, ctx):
        ...
        # Adds the variable used for from-to declaration to the recurrent variable stack
        # since we will create several quadruples using this variable without reading it again
    ...
    def exitReturn_type(self, ctx):
        # Sets a flag indicating whether the current function expects a return statement
    ...
    def enterTpp_return(self, ctx):
        ...
        if self.return_state == 0:
            # Unexpected return statement in void function
            print("[Error] Invalid return statement in void function")
            sys.exit()
        elif self.quadruple_list.p_jumps.size() == 1:
            # Expected return statement in base of function declaration
            self.return_state = 2
    ...
    def exitTpp_function(self, ctx):
        # Point 67
        if self.return_state == 1:
            # Function expected return statement but none was found outside of non-linear statements
    ...
    def exitInit_arr(self, ctx):
        # Receives information from DirGen method required to create an INST quadruple
    ...
    def exitFunc_name(self, ctx):
        ...
        # Verifies whether the called function is a method and searches for it
        ...
        # Pushing tuple of Function object and its parameter count to function call stack
    ...
    def exitArgument(self, ctx):
        ...
        # Gets the next parameter from the called function using the current parameter count
